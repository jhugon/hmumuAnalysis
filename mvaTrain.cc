...
int main(int argc, char *argv[])
{
   ...
   // Muon Only Analysis
    ...
    if (optionMap.count("vbfSelection") && optionMap["vbfSelection"].as<int>() == 1)
      cuts = "ptMu1>25. && ptMu2>25. && (mDiJet>300.0 && deltaEtaJets>3.0 && productEtaJets<0.0) && ptmiss<40.";
    else
      cuts = "ptMu1>25. && ptMu2>25. && !(mDiJet>300.0 && deltaEtaJets>3.0 && productEtaJets<0.0)";
