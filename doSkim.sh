...
nice ./skim NtupleDYJetsToLL_muSelSkim.root $DIR/NtuplesMCDYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph-tarball_Summer12_DR53X-PU_S10_START53_V7A-v1/*.root -c "$CUT"
nice ./skim NtupleRun2012A.root_muSelSkim.root $DIR/NtuplesDataSingleMuRun2012A-13Jul2012-v1/minimal/SingleMuRun2012A-13Jul2012-v1_minimal.root -c "$CUT"
